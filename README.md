...
1. Setup and deploy a database
	1. Setup and Deploy
		...
		1. **Review and Create**
	1. Link to VM
		1. <div style="width:auto; height:auto; background-color:red;">**TODO: Cosmos research on hold/canceled due to lack of useability when compared to above alternative**</div>
1. Create a table (or multiple)
1. Learn/Identify how to:
	1. Read
	1. Write
